...
iso_test!(
    ...
    "Text positioning operators (Td, TD, Tm)",
    {
        ...
        let notes = if passed {
            "Successfully generated PDF with text positioning"
        } else {
            "Failed to generate PDF with positioned text"
        };
...
iso_test!(
    ...
    "Text showing operators (Tj, TJ)",
    {
        ...
        let level_achieved = if passed { 2 } else { 1 };
        let notes = if passed {
            "Successfully generated PDF with text showing operations"
        } else {
            "Failed to generate PDF with text content"
        };
