...
fn test_extract_spanish_invoice_basic() {
    ...
    let fragments = vec![
        TextFragment::new("FACTURA".to_string(), 100.0, 700.0, 50.0, 12.0, 12.0),
        TextFragment::new(
            "Factura Nº: 2025-001".to_string(),
            100.0,
            680.0,
            150.0,
            10.0,
        ...
        TextFragment::new(
            "Base Imponible: 500,00 €".to_string(),
            100.0,
            300.0,
            200.0,
            10.0,
...
fn test_extract_no_matches() {
    let fragments = vec![TextFragment::new(
        "Some random text without invoice data".to_string(),
        100.0,
        700.0,
        200.0,
        12.0,
...
fn test_european_number_format() {
    let fragments = vec![
        ...
        TextFragment::new("IVA: 234,56 €".to_string(), 100.0, 685.0, 100.0, 10.0, 10.0),
    ];
...
fn test_extract_english_invoice_basic() {
    ...
    let fragments = vec![
        TextFragment::new("INVOICE".to_string(), 100.0, 700.0, 50.0, 12.0, 12.0),
        TextFragment::new(
            "Invoice Number: INV-2025-001".to_string(),
            100.0,
            680.0,
            180.0,
            10.0,
...
fn test_extract_german_invoice_basic() {
    ...
    let fragments = vec![
        TextFragment::new("RECHNUNG".to_string(), 100.0, 700.0, 60.0, 12.0, 12.0),
        TextFragment::new(
            "Rechnungsnummer: 2025-DE-001".to_string(),
            100.0,
            680.0,
            200.0,
            10.0,
        ...
        TextFragment::new(
            "Fälligkeitsdatum: 20.11.2025".to_string(),
            100.0,
            650.0,
            200.0,
            10.0,
        ...
        TextFragment::new(
            "USt-IdNr: DE123456789".to_string(),
            100.0,
            635.0,
            150.0,
            10.0,
...
fn test_extract_italian_invoice_basic() {
    ...
    let fragments = vec![
        TextFragment::new("FATTURA".to_string(), 100.0, 700.0, 50.0, 12.0, 12.0),
        TextFragment::new(
            "Fattura N. 2025-IT-001".to_string(),
            100.0,
            680.0,
            180.0,
            10.0,
