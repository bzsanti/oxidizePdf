...
impl StandardFontMetrics {
    /// Get the width of a character by its WinAnsi (Windows-1252) byte code.
    ...
    /// character is mapped to its WinAnsi byte before indexing the width table.
    /// Characters outside the WinAnsi repertoire resolve to `default_width`.
    pub fn char_width_unicode(&self, ch: char) -> i32 {
        match crate::text::encoding::winansi_encode_char(ch) {
            Some(byte) => self.widths[byte as usize],
    ...
    ///
    /// Iterates Unicode characters (not UTF-8 bytes) and maps each through
    /// WinAnsi, so non-ASCII text is measured correctly.
    pub fn get_string_width(&self, text: &str) -> i32 {
        text.chars().map(|ch| self.char_width_unicode(ch)).sum()
    }
...
pub static HELVETICA_METRICS: StandardFontMetrics = StandardFontMetrics {
    ...
    widths: [
        ...
        584, 278, 556, 278, 222, 556, 333, 1000, 556, 556, 333, 1000, 667, 333, 1000, 278, 611,
        278, 278, 222, 222, 333, 333, 350, 556, 1000, 333, 1000, 500, 333, 944, 278, 500, 667, 278,
        333, 556, 556, 556, 556, 260, 556, 333, 737, 370, 556, 584, 278, 737, 333, 400, 584, 333,
...
pub static HELVETICA_BOLD_METRICS: StandardFontMetrics = StandardFontMetrics {
    ...
    widths: [
        ...
        584, 278, 556, 278, 278, 556, 500, 1000, 556, 556, 333, 1000, 667, 333, 1000, 278, 611,
        278, 278, 278, 278, 500, 500, 350, 556, 1000, 333, 1000, 556, 333, 944, 278, 500, 667, 278,
        333, 556, 556, 556, 556, 280, 556, 333, 737, 370, 556, 584, 278, 737, 333, 400, 584, 333,
        333, 333, 611, 556, 278, 333, 333, 365, 556, 834, 834, 834, 611, 722, 722, 722, 722, 722,
        722, 1000, 722, 667, 667, 667, 667, 278, 278, 278, 278, 722, 722, 778, 778, 778, 778, 778,
        584, 778, 722, 722, 722, 722, 667, 667, 611, 556, 556, 556, 556, 556, 556, 889, 556, 556,
        556, 556, 556, 278, 278, 278, 278, 611, 611, 611, 611, 611, 611, 611, 584, 611, 611, 611,
        611, 611, 556, 611, 556,
    ],
    kerning: None,
};
...
pub static TIMES_ROMAN_METRICS: StandardFontMetrics = StandardFontMetrics {
    ...
    widths: [
        ...
        541, 250, 500, 250, 333, 500, 444, 1000, 500, 500, 333, 1000, 556, 333, 889, 250, 611, 250,
        250, 333, 333, 444, 444, 350, 500, 1000, 333, 980, 389, 333, 722, 250, 444, 722, 250, 333,
        500, 500, 500, 500, 200, 500, 333, 760, 276, 500, 564, 250, 760, 333, 400, 564, 300, 300,
...
pub static TIMES_BOLD_METRICS: StandardFontMetrics = StandardFontMetrics {
    ...
    widths: [
        ...
        520, 250, 500, 250, 333, 500, 500, 1000, 500, 500, 333, 1000, 556, 333, 1000, 250, 667,
        250, 250, 333, 333, 500, 500, 350, 500, 1000, 333, 1000, 389, 333, 722, 250, 444, 722, 250,
        333, 500, 500, 500, 500, 220, 500, 333, 747, 300, 500, 570, 250, 747, 333, 400, 570, 300,
        300, 333, 556, 540, 250, 333, 300, 330, 500, 750, 750, 750, 500, 722, 722, 722, 722, 722,
        722, 1000, 722, 667, 667, 667, 667, 389, 389, 389, 389, 722, 722, 778, 778, 778, 778, 778,
        570, 778, 722, 722, 722, 722, 722, 611, 556, 500, 500, 500, 500, 500, 500, 722, 444, 444,
        444, 444, 444, 278, 278, 278, 278, 500, 556, 500, 500, 500, 500, 500, 570, 500, 556, 556,
        556, 556, 500, 556, 500,
    ],
    kerning: None,
};
...
pub static TIMES_ITALIC_METRICS: StandardFontMetrics = StandardFontMetrics {
    ...
    widths: [
        ...
        541, 250, 500, 250, 333, 500, 556, 889, 500, 500, 333, 1000, 500, 333, 944, 250, 556, 250,
        250, 333, 333, 556, 556, 350, 500, 889, 333, 980, 389, 333, 667, 250, 389, 556, 250, 389,
        500, 500, 500, 500, 275, 500, 333, 760, 276, 500, 675, 250, 760, 333, 400, 675, 300, 300,
        333, 500, 523, 250, 333, 300, 310, 500, 750, 750, 750, 500, 611, 611, 611, 611, 611, 611,
        889, 667, 611, 611, 611, 611, 333, 333, 333, 333, 722, 667, 722, 722, 722, 722, 722, 675,
        722, 722, 722, 722, 722, 556, 611, 500, 500, 500, 500, 500, 500, 500, 667, 444, 444, 444,
        444, 444, 278, 278, 278, 278, 500, 500, 500, 500, 500, 500, 500, 675, 500, 500, 500, 500,
        500, 444, 500, 444,
    ],
    kerning: None,
};
...
pub static TIMES_BOLD_ITALIC_METRICS: StandardFontMetrics = StandardFontMetrics {
    ...
    widths: [
        ...
        570, 250, 500, 250, 333, 500, 500, 1000, 500, 500, 333, 1000, 556, 333, 944, 250, 611, 250,
        250, 333, 333, 500, 500, 350, 500, 1000, 333, 1000, 389, 333, 722, 250, 389, 611, 250, 389,
        500, 500, 500, 500, 220, 500, 333, 747, 266, 500, 606, 250, 747, 333, 400, 570, 300, 300,
        333, 576, 500, 250, 333, 300, 300, 500, 750, 750, 750, 500, 667, 667, 667, 667, 667, 667,
        944, 667, 667, 667, 667, 667, 389, 389, 389, 389, 722, 722, 722, 722, 722, 722, 722, 570,
        722, 722, 722, 722, 722, 611, 611, 500, 500, 500, 500, 500, 500, 500, 722, 444, 444, 444,
        444, 444, 278, 278, 278, 278, 500, 556, 500, 500, 500, 500, 500, 570, 500, 556, 556, 556,
        556, 444, 500, 444,
    ],
    kerning: None,
};
...
pub static COURIER_METRICS: StandardFontMetrics = StandardFontMetrics {
    ...
    widths: [
        ...
        600, 600, 600, 600, 600, 600, 600, 600, 600, 600, 600, 600, 600, 600, 600, 600, 600, 600,
        600, 600, 600, 600,
    ], // All characters are 600 units wide in Courier
    kerning: None,
};
...
mod tests {
    ...
    fn test_winansi_non_ascii_byte_widths_match_afm() {
        // #313: the 0x80-0xFF range must carry real Adobe AFM widths, not the
        // placeholder fillers that were there before.
        // Helvetica: iacute (0xED) = 278, emdash (0x97) = 1000, bullet (0x95) = 350.
        assert_eq!(HELVETICA_METRICS.get_char_width(0xED), 278);
        assert_eq!(HELVETICA_METRICS.get_char_width(0x97), 1000);
        assert_eq!(HELVETICA_METRICS.get_char_width(0x95), 350);
        assert_eq!(HELVETICA_METRICS.get_char_width(0xA9), 737); // copyright
                                                                 // Times-Roman: trademark (0x99) = 980, copyright (0xA9) = 760.
        assert_eq!(TIMES_ROMAN_METRICS.get_char_width(0x99), 980);
        assert_eq!(TIMES_ROMAN_METRICS.get_char_width(0xA9), 760);
    }

    #[test]
    fn test_char_width_unicode_maps_through_winansi() {
        // The Unicode accessor must reach the same AFM widths via WinAnsi.
        assert_eq!(HELVETICA_METRICS.char_width_unicode('í'), 278);
        assert_eq!(HELVETICA_METRICS.char_width_unicode('—'), 1000); // U+2014
        assert_eq!(HELVETICA_METRICS.char_width_unicode('•'), 350); // U+2022
        assert_eq!(TIMES_ROMAN_METRICS.char_width_unicode('™'), 980);
        // A char with no WinAnsi glyph falls back to default_width.
        assert_eq!(
            HELVETICA_METRICS.char_width_unicode('中'),
            HELVETICA_METRICS.default_width
        );
    }

    #[test]
    fn test_get_string_width_counts_chars_not_utf8_bytes() {
        // #313 bug: get_string_width iterated UTF-8 bytes, so a 2-byte char like
        // 'é' (0xC3 0xA9) produced two garbage lookups. It must now sum per-char.
        // Helvetica "café": c=500, a=556, f=278, é=556 = 1890.
        assert_eq!(HELVETICA_METRICS.get_string_width("café"), 1890);
        // Pure-ASCII path unchanged: "Abc" = A667 + b556 + c500 = 1723.
        assert_eq!(HELVETICA_METRICS.get_string_width("Abc"), 1723);
        // A 4-char accented word must equal the sum of its 4 char widths, never
        // the sum of its (more numerous) UTF-8 bytes.
        let s = "ñoño";
        let expected: i32 = s
            .chars()
            .map(|c| HELVETICA_METRICS.char_width_unicode(c))
            .sum();
        assert_eq!(HELVETICA_METRICS.get_string_width(s), expected);
        assert!(s.len() > s.chars().count()); // multi-byte: the bug would inflate this
    }
