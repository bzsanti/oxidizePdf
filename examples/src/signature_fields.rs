...
use oxidize_pdf::forms::{
    signature_field::{SignatureAppearance, SignatureField, SignerInfo},
    signature_handler::{SignatureHandler, SignatureSettings},
    signature_widget::{
        ImageFormat, InkStroke, SignatureVisualType, SignatureWidget, TextPosition,
    },
    BorderStyle, Widget, WidgetAppearance,
};
...
fn create_text_signature_page(doc: &mut Document) -> Result<(), PdfError> {
    ...
    // Add title
    page.add_text(
        "Text-Based Signature Field Example",
        50.0,
        700.0,
        Font::HelveticaBold,
        16.0,
    ...
    page.add_text(
        "This document requires your digital signature for approval.",
        50.0,
        650.0,
        Font::Helvetica,
        12.0,
...
fn create_ink_signature_page(doc: &mut Document) -> Result<(), PdfError> {
    ...
    // Add instructions
    page.add_text(
        "Please sign with your finger or stylus in the box below:",
        50.0,
        650.0,
        Font::Helvetica,
        12.0,
    ...
    let stroke3 = InkStroke {
        points: vec![(120.0, 460.0), (280.0, 460.0)],
        pressures: None,
    };
...
fn create_mixed_signature_page(doc: &mut Document) -> Result<(), PdfError> {
    ...
    // Add description
    page.add_text(
        "This signature combines an image with text information:",
        50.0,
        650.0,
        Font::Helvetica,
        12.0,
...
fn create_multiple_signatures_page(doc: &mut Document) -> Result<(), PdfError> {
    ...
    // Add description
    page.add_text(
        "This document requires multiple signatures:",
        50.0,
        650.0,
        Font::Helvetica,
        12.0,
    ...
    let appearance1 = widget1.generate_appearance_stream(false, None, None, None, None)?;
    ...
    let appearance2 = widget2.generate_appearance_stream(false, None, None, None, None)?;
    ...
    let appearance4 =
        widget4.generate_appearance_stream(true, Some("Sarah Wilson"), None, None, None)?;
...
mod tests {
    ...
    fn test_appearance_generation() {
        ...
        let appearance =
            widget.generate_appearance_stream(true, Some("John Doe"), None, None, None);
